...
mod crd_serialization_tests {
    ...
    fn test_config_serialization_podspec() {
        ...
        let expected_deserialized = r#"{"discoveryHandler":{"name":"random","discoveryDetails":""},"capacity":4,"uniqueDevices":false,"brokerSpec":{"brokerPodSpec":{"containers":[{"image":"nginx:latest","name":"broker"}]}},"brokerProperties":{}}"#;
    ...
    fn test_config_serialization_jobspec() {
        ...
        let serialized = serde_json::to_string(&deserialized).unwrap();
        let expected_deserialized = r#"{"discoveryHandler":{"name":"random","discoveryDetails":""},"capacity":4,"uniqueDevices":false,"brokerSpec":{"brokerJobSpec":{"template":{"spec":{"containers":[{"image":"nginx:latest","name":"broker"}],"restartPolicy":"OnFailure"}}}},"brokerProperties":{}}"#;
        assert_eq!(expected_deserialized, serialized);
    }
