...
if [ "$CHECK" == "1" ]; then
    ...
    YAML_FILES="$BASEDIR/deployment/helm/templates/debug-echo.yaml $BASEDIR/deployment/helm/templates/onvif.yaml $BASEDIR/deployment/helm/templates/udev.yaml $BASEDIR/deployment/helm/templates/opcua-monitoring.yaml"
