...
define agent_build_slim
	echo agent slim && \
	PKG_CONFIG_ALLOW_CROSS=1 cross build --release --target=$(1) --manifest-path agent/Cargo.toml
endef
...
# Build all Akri components except the Agent
define build_all_but_agent
	echo here && \
	PKG_CONFIG_ALLOW_CROSS=1 cross build --release --target=$(1) --workspace --exclude agent 
endef
#
#
