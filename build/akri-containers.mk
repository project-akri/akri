...
#    To make single component: `make akri-[controller|agent|udev|onvif|streaming|opcua-monitoring|anomaly-detection|configuration-validator|debug-echo-discovery|udev-discovery|onvif-discovery|opcua-discovery]`
#    To make specific platforms: `BUILD_AMD64=1 BUILD_ARM32=0 BUILD_ARM64=1 make akri-[controller|agent|udev|onvif|streaming|opcua-monitoring|anomaly-detection|configuration-validator|debug-echo-discovery|udev-discovery|onvif-discovery|opcua-discovery]`
