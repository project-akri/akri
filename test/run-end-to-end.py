...
def main():
    ...
    helm_install_command = "helm install akri {} --set agent.full=true --set debugEcho.enabled=true --set debugEcho.name={} --set agent.allowDebugEcho=true {} {} --debug ".format(helm_chart_location, shared_test_code.DEBUG_ECHO_NAME, cri_args, extra_helm_args)
