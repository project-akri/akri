...
2. Now it is time to install the Akri using Helm. When installing Akri, we can specify that we want to deploy the OPC UA
   ...
   Those are the tcp addresses that we modified in step 3 of [Creating OPC UA Servers](untitled.md#creating-opc-ua-servers). Be
